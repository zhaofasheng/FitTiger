...
- (void)setTcModel:(NoticeClockPyModel *)tcModel{
    ...
    self.contentBackView.frame = CGRectMake(15, CGRectGetMaxY(self.iconImageView.frame)+13-(self.isUserCenter?20:0), DR_SCREEN_WIDTH-70,tcModel.contentHeight+40);
    ...
    self.backView.frame = CGRectMake(20, 0, DR_SCREEN_WIDTH-40, 121+self.contentBackView.frame.size.height-(self.isUserCenter?20:0));
    ...
    if (tcModel.is_dubbed.intValue) {
        //Image_selfypy_b
        self.pyImageView.image = UIImageNamed(@"Image_tcyipeiy");
        self.hasL.text = [NoticeTools getLocalStrWith:@"py.pyed"];
    }else{
        self.pyImageView.image = UIImageNamed(@"Image_luynewzt");
    ...
    if ([_tcModel.user_id isEqualToString:[[NoticeSaveModel getUserInfo] user_id]]) {//自己的台词
        ...
        self.scImageV.image = UIImageNamed(@"Image_pyshoucang");
    }else{
        self.scL.text = [NoticeTools getLocalStrWith:@"emtion.sc"];
        self.scImageV.image = UIImageNamed(tcModel.collection_id.intValue?@"Image_pyshoucangy": @"Image_pyshoucang");
    }
...
- (UIView *)buttonView{
    if (!_buttonView) {
        ...
        self.hasL.textColor = [UIColor colorWithHexString:@"#FFFFFF"];
        ...
        self.scL.textColor = [UIColor colorWithHexString:@"#FFFFFF"];
        self.scL.text = [NoticeTools getLocalStrWith:@"emtion.sc"];
        ...
        shareImageView.image = UIImageNamed(@"Image_pyfenxiang");
        ...
        shareL.textColor = [UIColor colorWithHexString:@"#FFFFFF"];
