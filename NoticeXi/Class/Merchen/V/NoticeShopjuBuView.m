...
@implementation NoticeShopjuBuView
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.contentView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 280, 285)];
        ...
        NSArray *btnArr = @[@"人身攻击",@"色情暴力",@"垃圾广告"];
        for (int i = 0; i < 3; i++) {
            UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(30, 65+55*i, 220, 40)];
            button.tag = i;
        ...
        UIView *hline = [[UIView alloc] initWithFrame:CGRectMake(0, 240, 280, 1)];
...
- (void)typeClick:(UIButton *)button{
    ...
    [sureBtn setTitleColor:[UIColor colorWithHexString:@"#0099E6"] forState:UIControlStateNormal];
