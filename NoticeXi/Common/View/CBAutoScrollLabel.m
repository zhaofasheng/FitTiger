...
- (void)onUIApplicationDidChangeStatusBarOrientationNotification:(NSNotification *)notification {
    ...
    [self performSelector:@selector(refreshLabels) withObject:nil afterDelay:.0f];
    [self performSelector:@selector(scrollLabelIfNeeded) withObject:nil afterDelay:.0f];
}
