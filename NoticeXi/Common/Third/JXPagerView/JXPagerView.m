...
- (instancetype)initWithDelegate:(id<JXPagerViewDelegate>)delegate listContainerType:(JXPagerListContainerType)type {
    ...
    if (self) {
        ...
        _listContainerView.backgroundColor = [[UIColor redColor] colorWithAlphaComponent:0];
        _listContainerView.scrollView.backgroundColor = [[UIColor redColor] colorWithAlphaComponent:0];
...
- (void)refreshTableHeaderView {
    ...
    tableHeaderView.translatesAutoresizingMaskIntoConstraints = NO;    NSLayoutConstraint *top = [NSLayoutConstraint constraintWithItem:tableHeaderView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:containerView attribute:NSLayoutAttributeTop multiplier:1 constant:0];
    ...
    self.mainTableView.backgroundColor = [[UIColor redColor] colorWithAlphaComponent:0];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.backgroundColor = [[UIColor greenColor] colorWithAlphaComponent:0];
...
- (void)listContainerView:(JXPagerListContainerView *)listContainerView listDidAppearAtIndex:(NSInteger)index {
    ...
    self.currentScrollingListView.backgroundColor = [[UIColor redColor] colorWithAlphaComponent:0];
