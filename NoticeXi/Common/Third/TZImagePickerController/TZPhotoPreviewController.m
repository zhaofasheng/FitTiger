...
- (void)configCropView {
    ...
    if (_tzImagePickerVc.maxImagesCount <= 1 && _tzImagePickerVc.allowCrop) {
        ...
        _cropView.layer.borderColor = [UIColor colorWithHexString:WHITEMAINCOLOR].CGColor;
...
- (void)viewDidLayoutSubviews {
    ...
    _backButton.frame = CGRectMake(10,statusBarHeightInterval, 44, 44);
...
- (void)refreshNaviBarAndBottomBarState {
    ...
    if (_selectButton.isSelected && _tzImagePickerVc.showSelectedIndex && _tzImagePickerVc.showSelectBtn) {
        NSString *index = [NSString stringWithFormat:@"%lu", [_tzImagePickerVc.selectedAssetIds indexOfObject:model.asset.localIdentifier] + 1];
