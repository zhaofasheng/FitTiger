...
- (void)setContentScrollView:(UIScrollView *)contentScrollView
{
    ...
    _contentScrollView.backgroundColor = [GetColorWithName(VBackColor) colorWithAlphaComponent:0];
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cellModel.selectedType = JXCategoryCellSelectedTypeUnknown;
    cellModel.needRed = self.needRed;
    cellModel.red1 = self.red1;
    cellModel.red2 = self.red2;
    cellModel.red3 = self.red3;
