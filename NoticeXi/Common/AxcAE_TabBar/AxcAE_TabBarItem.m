...
- (void)setItemModel:(AxcAE_TabBarConfigModel *)itemModel{
    ...
    if ([_itemModel.normalImageName isEqualToString:@"tabbarsendbuton"]) {
        self.normalImage = UIImageNamed(_itemModel.normalImageName);
        self.selectImage = UIImageNamed(_itemModel.normalImageName);
    }else{
        self.normalImage = UIImageNamed(_itemModel.normalImageName);
