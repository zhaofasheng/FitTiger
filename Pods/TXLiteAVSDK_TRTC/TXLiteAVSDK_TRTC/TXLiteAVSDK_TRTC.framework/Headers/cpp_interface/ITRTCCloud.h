 ...
 */
     ...
     * 5.12 启用音量大小提示
     *
     * 开启此功能后，SDK 会在 {@link ITRTCCloudCallback} 中的 {@link onUserVoiceVolume} 回调中反馈本地推流用户和远端用户音频的音量大小以及远端用户的最大音量。
 ...
 * @param deviceName 您可以指定该参数为空置（nullptr），代表让 SDK 采集整个系统的声音。
 * @note
