...
/**
 * 7.1 直播时移准备，拉取该直播流的起始播放时间。
 *
 * @deprecated 从 9.9 版本开始，本接口已不再支持，请参考文档：[直播时移播放使用文档](https://cloud.tencent.com/document/product/454/7880#step-13.EF.BC.9A.E7.9B.B4.E6.92.AD.E5.9B.9E.E7.9C.8B)。
 */
 ...
 * 7.4 设置播放速率
 *
 * @deprecated 从 9.9 版本开始，本接口已不再支持，由 SDK 内部自动抉择，无需再调用，请忽略此接口。
 */
