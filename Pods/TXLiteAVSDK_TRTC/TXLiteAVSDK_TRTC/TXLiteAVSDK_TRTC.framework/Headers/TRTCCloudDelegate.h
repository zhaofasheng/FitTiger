 ...
 * @param extrainfo 额外信息。
 */
- (void)onRemoteAudioStatusUpdated:(NSString *)userId streamStatus:(TRTCAVStatusType)status reason:(TRTCAVStatusChangeReason)reason extrainfo:(nullable NSDictionary *)info;
